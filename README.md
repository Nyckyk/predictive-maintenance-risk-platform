...
Operational HIGH risk threshold
...
How much useful life is likely to remain?

Which assets need attention first?

How reliable is the estimated risk?

When could preventative maintenance be economically justified?
...
Correctly identified HIGH risk engines

20

Missed HIGH risk engines
...
paths, thresholds, feature names and financial assumptions

data.py

C-MAPSS loading and RUL target creation

models.py

model creation, training, cross-validation and OOF predictions

risk.py

risk categories, threshold optimisation and maintenance decisions

evaluation.py

test set and probability model evaluation

finance.py

financial calculations and cost sensitivity analysis

plotting.py

saved Matplotlib figures
